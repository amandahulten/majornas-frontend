  ...
  return (
    <div className={`text-black-coffee bg-temp-ey p-4 ${className}`}>
      ...
      <div className={`hidden md:flex gap-3 justify-end pt-16 ${display}`}>
        <Link
          href={`https://www.google.se/maps/place/${data.address},+414+60+G%C3%B6teborg/@57.6969908,11.9282245,17z/data=!3m1!4b1!4m5!3m4!1s0x464ff3484c99eba3:0x7fa4782120b55e0!8m2!3d57.696988!4d11.9304078?hl=sv`}
